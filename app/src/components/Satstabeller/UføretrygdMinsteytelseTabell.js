...
class UføretrygdMinsteytelseTabell extends React.Component {
    ...
    componentDidMount() {
        let url = 'https://pensjon-regler-' + this.props.valgtMiljø + '.dev.adeo.no/api/uføretrygdMinsteytelseSats?Aktiv=' + this.props.aktiv + '&Satstabell=' + this.props.currentTabell
        fetch(url
        ,{
          headers : { 
