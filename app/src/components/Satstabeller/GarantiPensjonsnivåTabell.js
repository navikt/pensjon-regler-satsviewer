...
class GarantiPensjonsnivåTabell extends React.Component {
    ...
    componentDidMount() {
        let url = 'https://pensjon-regler-' + this.props.valgtMiljø + '.dev.adeo.no/api/garantiPensjonsNivåSats?Aktiv=' + this.props.aktiv + '&Satstabell=' + this.props.currentTabell
        fetch(url
            , {
                headers: {
        ...
        return (
            ...
            <div>
                <div onClick={
                    ...
                    <Satsheader headline="Garantipensjonsnivå" show={
                        this
                            .state
                            .show
                    }></Satsheader>
