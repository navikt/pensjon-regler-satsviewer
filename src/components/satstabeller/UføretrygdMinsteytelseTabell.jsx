...
import { uføretrygdMinsteytelseSats } from "../../contants/Constants";
import { querySatsTabellByMiljøAndTypeAndAktiv } from "../../service/Queries";
import DefaultTable from "../DefaultTable";
import { useQueryClient } from '@tanstack/react-query';

const UføretrygdMinsteytelseTabell = ({ environment, satstabell }) => {
                                ...
                                {data[1]?.map((rad, key) => {
                                    return (
                                        <Table.Row key={key}>
                                            ...
                                            <Table.DataCell>{rad?.forsorgerEktefelleOver60.toString()}</Table.DataCell>
