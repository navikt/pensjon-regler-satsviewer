...
const EØSKonvensjonslandTabell: FC<EØSKonvensjonslandTabellProps> = ({ environment, satstabell }) => {
    ...
    const { data, isError, isLoading, isSuccess, isFetching } = querySatsTabellByMiljøAndType(environment, type, satstabell) as UseQueryResult<EosKonvensjonsLandSatser>;
