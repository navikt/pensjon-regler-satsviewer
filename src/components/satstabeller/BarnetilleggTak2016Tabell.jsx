...
import {barnetilleggTak2016Sats} from "../../contants/Constants";
import {querySatsTabellByMiljøAndTypeAndAktiv} from "../../service/Queries";
import DefaultTable from "../DefaultTable";
import {useQueryClient} from '@tanstack/react-query';

const BarnetilleggTak2016Tabell = ({environment, satstabell}) => {
    ...
    const {
        ...
        isSuccess,
        isFetching
    } = querySatsTabellByMiljøAndTypeAndAktiv(environment, type, false, satstabell);
